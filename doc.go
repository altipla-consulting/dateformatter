...
// 
// It has the same formatting options as the time package, excluding timezones
// and nanoseconds as they are not needed in a daily basis to format user dates
// and times.
// 
